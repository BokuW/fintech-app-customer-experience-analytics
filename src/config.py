...
# Placeholder IDs
APP_IDS = {
    "Commercial Bank of Ethiopia": "com.cbe.mobile.banking", # Verify this ID
    "Bank of Abyssinia": "com.boa.mobile.banking",          # Find actual ID
    "Dashen Bank": "com.dashen.mobile.banking"              # Find actual ID
}
